    ...
    <div>
      ...
      <Row>
            ...
            <Card.Body>
              ...
              {order.isDelivered ? (
                <MessageBox variant="success">
                  Kézbesítve {order.deliveredAt}
                </MessageBox>
              ) : (
                <MessageBox variant="danger">Szállítás alatt</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Fizetési mód: </strong> {order.paymentMethod}
              </Card.Text>
              {order.isPaid ? (
                <MessageBox variant="success">
                  ...
                  <ListGroup.Item key={item._id}>
                    <Row className="align-items-center">
                      <Col md={6}>
                        ...
                        ></img>{' '}
                        <Link to={`/product/${item.key}`}>{item.title}</Link>
                      </Col>
                      <Col md={3}>
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Rendelés összege</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Termékek</Col>
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Összesen</Col>
                    <Col>{order.totalPrice.toFixed(2)} Ft</Col>
                  </Row>
                </ListGroup.Item>
              </ListGroup>
              {!order.isPaid && (
